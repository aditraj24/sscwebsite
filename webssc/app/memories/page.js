  ...
  const memories = [
    {
      ...
      description: "An inspiring workshop where students learned essential leadership skills through interactive sessions and team-building activities. The event featured renowned speakers from the industry who shared their experiences and insights on effective leadership in the modern workplace.",
      ...
      feedback: "The workshop was incredibly insightful and practical. I learned valuable skills that I can apply in my career. - Priya Sharma, 3rd Year CSE"
    },
    {
      id: 2,
      ...
      feedback: "This competition helped me overcome my fear of public speaking and improved my confidence significantly. - Rahul Verma, 2nd Year ECE"
    },
    {
      id: 3,
      ...
      image: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&h=600&fit=crop",
      description: "A networking event connecting students with industry professionals to understand real-world soft skills requirements.",
      longDescription: "The Industry Connect Meet 2024 was a landmark event that bridged the gap between academia and industry. Representatives from leading companies including TCS, Infosys, Wipro, and Tata Steel participated in this comprehensive networking and learning event.\n\nEvent Highlights:\n- Company presentations and Q&A sessions\n- Mock interview sessions with HR professionals\n- Resume building workshops\n- Networking lunch with industry leaders\n- Panel discussion on 'Future of Work'\n\nStudents had the opportunity to interact directly with hiring managers, understand industry expectations, and build professional relationships. The event also featured skill assessment sessions and career counseling.",
      category: "Networking",
      participants: 60,
      ...
      feedback: "This event opened my eyes to industry expectations and helped me understand what skills I need to develop. - Anjali Gupta, 4th Year ME"
    },
    {
      id: 4,
      ...
      image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop",
      description: "Students engaged in innovative problem-solving challenges, developing critical thinking and creativity skills.",
      longDescription: "The Creative Problem Solving workshop was an innovative event that challenged students to think outside the box and develop creative solutions to real-world problems. The workshop used design thinking methodology and hands-on activities to enhance problem-solving skills.\n\nWorkshop Activities:\n- Design thinking exercises\n- Brainstorming sessions\n- Prototype development\n- Solution presentation\n- Peer feedback sessions\n\nStudents worked in teams to solve problems related to sustainability, technology, and social impact. The workshop emphasized collaboration, creativity, and practical application of theoretical knowledge.",
      category: "Workshop",
      participants: 38,
      ...
      feedback: "This workshop completely changed my approach to problem-solving. I now think more creatively and systematically. - Vikram Singh, 3rd Year CSE"
    },
    {
      id: 5,
      ...
      image: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&h=600&fit=crop",
      description: "A celebration of diversity through cultural exchange, promoting understanding and collaboration among students.",
      longDescription: "The Cultural Exchange Program was a vibrant celebration of India's diverse cultural heritage. Students from different states and backgrounds came together to showcase their traditions, music, dance, and cuisine.\n\nProgram Highlights:\n- Traditional dance performances\n- Folk music concerts\n- Cultural fashion show\n- Regional cuisine stalls\n- Cultural quiz competition\n- Traditional games and activities\n\nThe event featured performances from various regions including Punjab, Kerala, Rajasthan, and North East India. Students learned about different cultures, traditions, and customs, promoting unity in diversity.",
      category: "Cultural",
      participants: 55,
      ...
      feedback: "This event helped me understand and appreciate the rich cultural diversity of our country. - Meera Patel, 2nd Year CE"
    },
    {
      id: 6,
      ...
      image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop",
      description: "Students practiced interview skills with industry professionals, gaining valuable feedback and confidence.",
      longDescription: "The Mock Interview Sessions provided students with a realistic interview experience to prepare them for their upcoming placement season. Industry professionals from various sectors conducted mock interviews and provided detailed feedback.\n\nSession Structure:\n- Technical interview rounds\n- HR interview simulations\n- Group discussion sessions\n- Resume review and feedback\n- Interview tips and strategies\n\nStudents received personalized feedback on their communication skills, technical knowledge, body language, and overall interview performance. The sessions helped build confidence and identify areas for improvement.",
      category: "Training",
      participants: 42,
      ...
      feedback: "The mock interviews helped me understand my strengths and weaknesses. I feel much more confident now. - Arjun Reddy, 4th Year EEE"
    }
  ];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0B6B52] to-[#083D30]">
        ...
        >
          ...
          <p className="text-[#0B6B52] font-semibold text-lg">Loading Memories...</p>
        </motion.div>
      </div>
    );
  }
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              >
                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFD8C2] to-[#FBC5C5]">Memories</span>
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Relive the moments that shaped our journey. From workshops to competitions, 
                every memory is a step towards personal and professional growth.
              </motion.p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative h-96 md:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
            <AnimatePresence mode="wait">
              ...
              >
                <div 
                  ...
                  style={{ backgroundImage: `url(${carouselMemories[currentCarouselIndex].image})` }}
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                    <div className="max-w-2xl">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-[#FFD8C2]">{carouselMemories[currentCarouselIndex].date}</span>
                        <span className="text-[#FFD8C2]">{carouselMemories[currentCarouselIndex].participants} participants</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {carouselMemories.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentCarouselIndex ? 'bg-[#FFD8C2] scale-125' : 'bg-[#FFD8C2]/50 hover:bg-[#FFD8C2]/75'
                  }`}
                />
              ))}
            </div>
            ...
            {/* Navigation Arrows */}
            <button
              onClick={() => setCurrentCarouselIndex((prev) => (prev - 1 + carouselMemories.length) % carouselMemories.length)}
            ...
            <button
              onClick={() => setCurrentCarouselIndex((prev) => (prev + 1) % carouselMemories.length)}
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 group-hover:shadow-2xl">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-[#FFD8C2]">{memory.date}</span>
              ...
              >
                ...
                <div className="p-8">
                      ...
                      <div className="bg-gray-50 rounded-xl p-6">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center">
                            <svg className="w-5 h-5 text-[#0B6B52] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            <span className="text-gray-700"><strong>Organizer:</strong> {selectedMemory.organizer}</span>
                          </div>
                          <div className="flex items-center">
                            <svg className="w-5 h-5 text-[#0B6B52] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span className="text-gray-700"><strong>Participants:</strong> {selectedMemory.participants}</span>
                          </div>
                          <div className="flex items-center">
                            <svg className="w-5 h-5 text-[#0B6B52] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                            </svg>
                            <span className="text-gray-700"><strong>Category:</strong> {selectedMemory.category}</span>
                          </div>
                        </div>
                      </div>
                        ...
                        <ul className="space-y-2">
                          {selectedMemory.highlights.map((highlight, index) => (
                            <li key={index} className="flex items-start">
                              <svg className="w-5 h-5 text-[#0B6B52] mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="bg-gradient-to-r from-[#FFD8C2] to-[#FBC5C5] rounded-xl p-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Participant Feedback</h3>
                    <div className="bg-white rounded-lg p-6 shadow-sm">
                      <div className="flex items-start">
                        <div className="w-12 h-12 bg-[#0B6B52] rounded-full flex items-center justify-center text-white font-bold mr-4 flex-shrink-0">
                          {selectedMemory.feedback.split(' - ')[1]?.charAt(0) || 'S'}
                        </div>
                        <div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              >
                <div className="text-4xl font-bold mb-2">{memories.length}+</div>
              ...
              <motion.div
                ...
                className="text-white"
              >
                <div className="text-4xl font-bold mb-2">{memories.reduce((sum, m) => sum + m.participants, 0)}+</div>
