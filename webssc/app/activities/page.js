...
const galleries = [
  ...
  },
  {
    title: "Visioucue",
    description:
      "In this engaging session, participants were shown a thought-provoking image designed to spark curiosity .Following a brief individual observation phase, attendees formed small groups to initiate open-ended discussions based on what they saw —emotions, context, and possible narratives behind the image.",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Fun Events | Case Study | Group Discussion | Debate | Creative Writing
          | Mock Interview | Naivete Fete Nite
        </Typography>
      </Box>
      ;
    </Box>
